...
class DeviceID:
	...
	def getName(self, val):
		...
		if val == self.PHIDID_SPT_PROTO:
			return "PHIDID_SPT_PROTO"
		...
		if val == self.PHIDID_1067_1:
			return "PHIDID_1067_1"
		if val == self.PHIDID_HUM1100:
			return "PHIDID_HUM1100"
		if val == self.PHIDID_VINTSPATIAL:
			return "PHIDID_VINTSPATIAL"
